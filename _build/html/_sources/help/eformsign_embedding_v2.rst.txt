...
.. code-block:: javascript
    ...
    var document_option = {
       ...
       "user" : {
            ...
            "access_token" : "",    // Access Tokenの入力（eformsign APIの使い方 - Access Tokenの発行を参照）
            "refresh_token" : "",   // Refresh Tokenの入力（eformsign APIの使い方 - Access Tokenの発行を参照）
...
.. list-table:: 
   ...
   * - access_token
     ...
     - String
     - X
     - Open API > `Access Token 発行 <https://eformsignjp.github.io/developers/help/eformsign_api.html#id5>`__ を参照
   * - refresh_token
     - Refresh Token
     - String
     - X
   ...
   * - external_token
     ...
     - String
     - X
     - メンバーではないユーザーが受信した文書を検討する際は必須入力（`Webhook <https://eformsignjp.github.io/developers/help/eformsign_webhook.html>`__ で提供）
   * - external_user_info
     - 外部作成者の情報
     - String
     - X
...
..
    ...
    変数名                     説明                            データ型       必須     備考 
    =========================  ==============================  =============  =======  ==========================================================================
    type                       ユーザータイプ                  String         O        01: 会社メンバー
...
.. list-table::
   ...
   * - recipients[].auth.password
     ...
     - String         
     - X        
     - - ワークフローの設定における本人確認を設定 
       - 本人確認情報にチェックを入れた場合、パスワードを入力
...
.. list-table:: 
   ...
   * - access_token
     ...
     - String
     - X
     - Open API > `Access Tokenを発行 <https://eformsignjp.github.io/developers/help/eformsign_api.html#id5>`__
   * - refresh_token
     - Refresh Token
     - String
     - X
...
.. list-table:: 
   ...
   * - values
     - Object
     - document_optionに定義されたreturn_fieldsに入力したフィールド名に対してユーザーが入力した値を返却
     - 
   ...
   * - recipients[].step_idx
     ...
     - ワークフローの順序
     - 
     - 1番目の受信者: "2"、2人目以降の受信者: 3, 4...と順番に沿って1ずつ増加
   * - recipients[].step_type
     - String
     - 受信者の種類
     - 
